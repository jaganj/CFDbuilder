//===-------------- uniqueDefValue.java - inliner helper class ------------===//
//
//  This class represents whether a variable name in the callee is in the 
//  unique in the caller. If so, we retain the name. It also tracks if the 
//  defintion for the variable is already included in the caller during 
//  inlining.
//
//===----------------------------------------------------------------------===//
//
...
class uniqueDefValue {
	boolean isUnique;
	boolean isDefIncluded;
}
