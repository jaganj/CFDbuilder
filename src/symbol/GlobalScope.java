//===------------------ GlocalScope.java - Global scope -------------------===//
//
//  This file implements the global scope type for Fortran
//
//===----------------------------------------------------------------------===//
//
...
public class GlobalScope extends BaseScope {
	public Map<String, FunctionSymbol> enclosedFunctions = new LinkedHashMap<String, FunctionSymbol>();
    public GlobalScope() { super(null,"global"); }
